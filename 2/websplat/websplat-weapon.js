            ...
            var BazookaFireIOHandler = (function (_super) {
                ...
                BazookaFireIOHandler.prototype.onmousedown = function (ev) {
                    ...
                    this.ivID = setInterval(function () {
                        ...
                        iothis.line.drawBar(Math.round(WebSplat.player.x + WebSplat.player.w / 2), Math.round(WebSplat.player.y), iothis.mx, iothis.my, 255, 0, 0, 3, bazTime * 128, 0, 0, 0, 9, 128);
                    }, 15);
                    return false;
                };
